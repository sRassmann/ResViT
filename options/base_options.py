...
class BaseOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument(
            "--vit_name", type=str, default="Res-ViT-B_16", help="vit type"
        )
        self.parser.add_argument(
            "--pre_trained_path",
            type=str,
            default="./checkpoints/T1_T2_PD_IXI/latest_net_G.pth",
            help="path to the pre-trained resnet architecture",
        )
        self.parser.add_argument(
            "--pre_trained_transformer",
            type=int,
            default=1,
            help="Pre-trained ViT or not",
        )
        self.parser.add_argument(
            "--pre_trained_resnet",
            type=int,
            default=0,
            help="Pre-trained residual CNNs or not",
        )
